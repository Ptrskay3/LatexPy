...
from latexpy.core.visitors import DefaultChildIndentVisitor
...
class CodeGen(object):
    ...
    def generate(self,tex_tree:Tex, indent_visitor:DefaultChildIndentVisitor=DefaultChildIndentVisitor()):
